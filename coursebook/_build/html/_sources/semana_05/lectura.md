...
Sin embargo, como dicta un axioma informal de la dinámica de sistemas, "las soluciones de hoy son los problemas de mañana". El CxC, al funcionar exactamente como se diseñó, introdujo consecuencias sistémicas no previstas a largo plazo. 
...
Frank Knight, en su obra seminal *Risk, Uncertainty and Profit* (1921), y más tarde John Maynard Keynes, trazaron una distinción filosófica y práctica que es central para la analítica de sistemas: la diferencia entre **riesgo** e **incertidumbre profunda** (*deep uncertainty*).
